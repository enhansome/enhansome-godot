...
* [Unknown Horizons](https://github.com/unknown-horizons/godot-port) ⭐ 906 | 🐛 14 | 🌐 GDScript | 📅 2026-09-14 - Official work-in-progress reimplementation of Unknown Horizons.
* [Worlds Upon The Wind](https://github.com/max99x/wutw-public) ⭐ 208 | 🐛 0 | 🌐 GDScript | 📅 2026-09-19 - A commercial roguelite deckbuilder released as public domain.
...
* [Starship Olympics](https://github.com/notapixelstudio/starship-olympics) ⭐ 525 | 🐛 131 | 🌐 GDScript | 📅 2026-09-19 - Fast-paced local party game with starships that battle in a top-down arena.
...
* [Thrive](https://github.com/Revolutionary-Games/Thrive/) ⭐ 3,712 | 🐛 526 | 🌐 C# | 📅 2026-09-20 - A free, open-source game about the evolution of life (Mono).
* [Reia](https://github.com/Quaint-Studios/Reia) ⭐ 949 | 🐛 16 | 🌐 GDScript | 📅 2026-09-11 - A free game that's an action adventure RPG for Desktop and Mobile with multiplayer, MMO, and offline support.
...
* [Tanks of Freedom II](https://github.com/P1X-in/Tanks-of-Freedom-3-D) ⭐ 427 | 🐛 9 | 🌐 GDScript | 📅 2025-10-02 - Free turn-based isometric strategy game in voxel art.
...
* [Pixelorama](https://github.com/Orama-Interactive/Pixelorama) ⭐ 10,344 | 🐛 86 | 🌐 GDScript | 📅 2026-09-15 - 2D pixel art editor.
* [Lorien](https://github.com/mbrlabs/Lorien) ⭐ 6,801 | 🐛 78 | 🌐 GDScript | 📅 2025-09-22 - Infinite-canvas drawing/whiteboarding app for Windows, Linux and macOS. Supports drawing tablets and pressure sensitivity.
* [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,929 | 🐛 323 | 🌐 GDScript | 📅 2026-09-14 - Create PBR materials procedurally (similar to Substance Designer).
* [GodSVG](https://github.com/MewPurPur/GodSVG) ⭐ 2,748 | 🐛 54 | 🌐 GDScript | 📅 2026-09-18 - Tool to create optimized Scalable Vector Graphics files.
...
* [Maaack's Game Template](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,655 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
...
* [Godot Demo Projects](https://github.com/godotengine/godot-demo-projects) ⭐ 9,542 | 🐛 86 | 🌐 GDScript | 📅 2026-09-08 - Official Godot demo projects (everything except the TPS demo).
* [OpenRPG](https://github.com/GDquest/godot-open-rpg) ⭐ 2,981 | 🐛 6 | 🌐 GDScript | 📅 2026-05-01 - JRPG-style game demo and template.
...
* [Dialogic](https://github.com/dialogic-godot/dialogic) ⭐ 6,010 | 🐛 178 | 🌐 GDScript | 📅 2026-08-30 - Create dialogs, characters and scenes to display conversations.
* [Terrain3D](https://github.com/TokisanGames/Terrain3D) ⭐ 4,281 | 🐛 93 | 🌐 C++ | 📅 2026-09-15 - A high performance, editable 3D terrain system.
* [Dialogue Manager](https://github.com/nathanhoad/godot_dialogue_manager) ⭐ 3,865 | 🐛 2 | 🌐 GDScript | 📅 2026-09-09 - A simple but powerful text based branching dialogue editor and runtime. *(Godot 3 and 4)*
...
* [Beehave](https://github.com/bitbrain/beehave) ⭐ 3,281 | 🐛 30 | 🌐 GDScript | 📅 2026-08-18 - Enables you to create robust NPC AI systems using behavior trees.
* [LimboAI](https://github.com/limbonaut/limboai) ⭐ 3,020 | 🐛 61 | 🌐 C++ | 📅 2026-09-04 - Behavior trees and state machines. Comes with editor, visual debugger, comprehensive demo and tutorial.
* [ProtonScatter](https://github.com/HungryProton/scatter) ⭐ 2,988 | 🐛 70 | 🌐 GDScript | 📅 2026-07-26 - Automates the positioning of assets in a scene.
* [GUT](https://github.com/bitwes/Gut) ⭐ 2,733 | 🐛 76 | 🌐 GDScript | 📅 2026-08-18 - Utility for writing unit tests in GDScript.
...
* [Maaack's Game Template Plugin](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,655 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
* [Orchestrator](https://github.com/Vahera/godot-orchestrator) ⭐ 1,628 | 🐛 120 | 🌐 C++ | 📅 2026-09-20 - Dialog and visual-scripting subsystem for 2D and 3D games.
...
* [Aseprite Wizard](https://github.com/viniciusgerevini/godot-aseprite-wizard) ⭐ 1,367 | 🐛 24 | 🌐 GDScript | 📅 2026-08-17 - Plugin for importing animations from Aseprite as SpriteFrames.
* [TerraBrush](https://github.com/spimort/TerraBrush) ⭐ 1,283 | 🐛 24 | 🌐 C++ | 📅 2026-09-20 - Minimal Terrain heightmap editor that features sculpting, painting textures, LOD, and MultiZones.
...
* [Netfox](https://github.com/foxssake/netfox) ⭐ 1,098 | 🐛 48 | 🌐 GDScript | 📅 2026-09-20 - Multiplayer timing, rollback and other multiplayer features.
* [Script-IDE](https://github.com/Maran23/script-ide) ⭐ 1,051 | 🐛 9 | 🌐 GDScript | 📅 2026-09-02 - Transforms the script editor into an IDE-like UI. Multiline tabs, improved outline, quick open and override, enhanced keyboard navigation.
...
* [func\_godot](https://github.com/func-godot/func_godot_plugin) ⭐ 849 | 🐛 12 | 🌐 GDScript | 📅 2026-09-08 - Import maps using the [Quake MAP file format](https://quakewiki.org/wiki/Quake_Map_Format), commonly made using an editor such as [TrenchBroom](https://trenchbroom.github.io/).
* [godot-ink](https://github.com/paulloz/godot-ink) ⭐ 785 | 🐛 12 | 🌐 C# | 📅 2026-07-04 - A C# (Mono) plugin to integrate stories writen in [ink](https://github.com/inkle/ink) ⭐ 4,944 | 🐛 371 | 🌐 C# | 📅 2026-05-05, a scripting language for writing interactive narrative.
* [friflo ECS](https://github.com/friflo/Friflo.Engine.ECS) ⭐ 773 | 🐛 41 | 🌐 C# | 📅 2026-07-03 - High-performance C# ECS with simple API. Supports .NET, WASM/WebAssembly, Native AOT, Godot, Unity, MonoGame, ... *(Godot 3 and 4)*
* [Godot XR Tools](https://github.com/godotvr/godot-xr-tools) ⭐ 726 | 🐛 126 | 🌐 GDScript | 📅 2026-08-02 - Basic components for XR development.
...
* [YATI (Yet Another Tiled Importer](https://github.com/Kiamo2/YATI) ⭐ 295 | 🐛 9 | 🌐 GDScript | 📅 2026-03-19 - This is an addon for importing files (.tmx, .tmj) created by the [Tiled Map Editor](https://github.com/mapeditor/tiled) ⭐ 12,899 | 🐛 837 | 🌐 C++ | 📅 2026-09-17.
...
* [Sprouty Dialogs](https://github.com/SproutyLabs/SproutyDialogs) ⭐ 167 | 🐛 3 | 🌐 GDScript | 📅 2026-09-15 - A graph-based visual dialogue system, to create dialogues in your games incredibly easy! 🌱
...
* [Goblend](https://github.com/Togira123/Goblend-Export-Addon) ⭐ 105 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Export Blender scenes to Godot with one click, including materials, collisions and nested scenes.
...
* [AgonesSDK](https://github.com/AndreMicheletti/godot-agones-sdk) ⭐ 88 | 🐛 0 | 🌐 GDScript | 📅 2026-06-09 - Plugin to add [Agones](https://github.com/googleforgames/agones) ⭐ 7,034 | 🐛 59 | 🌐 Go | 📅 2026-09-20 SDK functionality to Godot.
...
* [Godot Shaders](https://github.com/GDQuest/godot-shaders) ⭐ 4,127 | 🐛 6 | 🌐 GDShader | 📅 2026-05-16 - A large library of free and open-source shaders for 2D and 3D.
...
* [godot-jolt](https://github.com/godot-jolt/godot-jolt) ⭐ 2,563 | 🐛 6 | 🌐 C++ | 📅 2026-03-16 - Allows you to use the [Jolt Physics Engine](https://github.com/jrouwe/JoltPhysics) ⭐ 11,566 | 🐛 13 | 🌐 C++ | 📅 2026-09-20.
* [Godex](https://github.com/GodotECS/godex) ⭐ 1,422 | 🐛 26 | 🌐 C++ | 📅 2023-09-18 - An entity component system library.
* [godot-rapier-2d](https://github.com/appsinacup/godot-rapier-2d) ⭐ 1,008 | 🐛 23 | 🌐 Rust | 📅 2026-09-15 - A 2D [Rapier](https://github.com/dimforge/rapier) ⭐ 5,749 | 🐛 54 | 🌐 Rust | 📅 2026-09-19 physics server for Godot.
...
* [Tree3D](https://github.com/JekSun97/gdTree3D) ⭐ 366 | 🐛 5 | 🌐 C++ | 📅 2026-09-13 - A plugin for procedural generation of 3D trees in real time for gaming projects.
...
* [spout-gd](https://github.com/you-win/spout-gd) ⭐ 85 | 🐛 13 | 🌐 C++ | 📅 2025-12-24 - Share OpenGL textures across Windows applications through your GPU using [Spout](https://github.com/leadedge/Spout2) ⭐ 1,008 | 🐛 0 | 🌐 C++ | 📅 2026-08-13.
...
* [godot-python](https://github.com/touilleMan/godot-python) ⭐ 2,091 | 🐛 129 | 🌐 Python | 📅 2026-03-12 - Python support for Godot 3.
...
* [JetBrains Rider (C#)](https://github.com/JetBrains/godot-support) ⭐ 506 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-20 - Syntax highlighting, autocompletion and run configurations.
