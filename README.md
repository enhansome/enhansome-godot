...
* [Worlds Upon The Wind](https://github.com/max99x/wutw-public) ⭐ 211 | 🐛 0 | 🌐 GDScript | 📅 2026-09-20 - A commercial roguelite deckbuilder released as public domain.
...
* [Starship Olympics](https://github.com/notapixelstudio/starship-olympics) ⭐ 525 | 🐛 131 | 🌐 GDScript | 📅 2026-09-20 - Fast-paced local party game with starships that battle in a top-down arena.
...
* [Thrive](https://github.com/Revolutionary-Games/Thrive/) ⭐ 3,711 | 🐛 526 | 🌐 C# | 📅 2026-09-21 - A free, open-source game about the evolution of life (Mono).
...
* [Pixelorama](https://github.com/Orama-Interactive/Pixelorama) ⭐ 10,349 | 🐛 86 | 🌐 GDScript | 📅 2026-09-20 - 2D pixel art editor.
* [Lorien](https://github.com/mbrlabs/Lorien) ⭐ 6,805 | 🐛 78 | 🌐 GDScript | 📅 2025-09-22 - Infinite-canvas drawing/whiteboarding app for Windows, Linux and macOS. Supports drawing tablets and pressure sensitivity.
* [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,934 | 🐛 323 | 🌐 GDScript | 📅 2026-09-20 - Create PBR materials procedurally (similar to Substance Designer).
* [GodSVG](https://github.com/MewPurPur/GodSVG) ⭐ 2,749 | 🐛 54 | 🌐 GDScript | 📅 2026-09-21 - Tool to create optimized Scalable Vector Graphics files.
...
* [Maaack's Game Template](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,656 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
...
* [Godot Demo Projects](https://github.com/godotengine/godot-demo-projects) ⭐ 9,550 | 🐛 86 | 🌐 GDScript | 📅 2026-09-08 - Official Godot demo projects (everything except the TPS demo).
...
* [Dialogic](https://github.com/dialogic-godot/dialogic) ⭐ 6,013 | 🐛 178 | 🌐 GDScript | 📅 2026-08-30 - Create dialogs, characters and scenes to display conversations.
* [Terrain3D](https://github.com/TokisanGames/Terrain3D) ⭐ 4,282 | 🐛 90 | 🌐 C++ | 📅 2026-09-15 - A high performance, editable 3D terrain system.
* [Dialogue Manager](https://github.com/nathanhoad/godot_dialogue_manager) ⭐ 3,866 | 🐛 4 | 🌐 GDScript | 📅 2026-09-09 - A simple but powerful text based branching dialogue editor and runtime. *(Godot 3 and 4)*
* [Phantom Camera](https://github.com/ramokz/phantom-camera) ⭐ 3,569 | 🐛 66 | 🌐 GDScript | 📅 2026-09-19 - Designed to provide and simplify common behaviors for the built-in Camera2D and Camera3D nodes.
* [Beehave](https://github.com/bitbrain/beehave) ⭐ 3,281 | 🐛 28 | 🌐 GDScript | 📅 2026-09-20 - Enables you to create robust NPC AI systems using behavior trees.
* [LimboAI](https://github.com/limbonaut/limboai) ⭐ 3,022 | 🐛 61 | 🌐 C++ | 📅 2026-09-04 - Behavior trees and state machines. Comes with editor, visual debugger, comprehensive demo and tutorial.
* [ProtonScatter](https://github.com/HungryProton/scatter) ⭐ 2,989 | 🐛 70 | 🌐 GDScript | 📅 2026-07-26 - Automates the positioning of assets in a scene.
* [GUT](https://github.com/bitwes/Gut) ⭐ 2,734 | 🐛 76 | 🌐 GDScript | 📅 2026-08-18 - Utility for writing unit tests in GDScript.
...
* [Maaack's Game Template Plugin](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,656 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
* [Orchestrator](https://github.com/Vahera/godot-orchestrator) ⭐ 1,628 | 🐛 120 | 🌐 C++ | 📅 2026-09-21 - Dialog and visual-scripting subsystem for 2D and 3D games.
...
* [TerraBrush](https://github.com/spimort/TerraBrush) ⭐ 1,285 | 🐛 27 | 🌐 C++ | 📅 2026-09-21 - Minimal Terrain heightmap editor that features sculpting, painting textures, LOD, and MultiZones.
* [GdUnit4](https://github.com/MikeSchulze/gdUnit4) ⭐ 1,238 | 🐛 13 | 🌐 GDScript | 📅 2026-08-30 - Godot Unit Testing Framework.
...
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,121 | 🐛 16 | 🌐 Rust | 📅 2026-09-21 - Local large language models (LLMs) for "AI-powered" NPC dialogue.
* [Netfox](https://github.com/foxssake/netfox) ⭐ 1,102 | 🐛 48 | 🌐 GDScript | 📅 2026-09-20 - Multiplayer timing, rollback and other multiplayer features.
...
* [Script-IDE](https://github.com/Maran23/script-ide) ⭐ 1,052 | 🐛 9 | 🌐 GDScript | 📅 2026-09-02 - Transforms the script editor into an IDE-like UI. Multiline tabs, improved outline, quick open and override, enhanced keyboard navigation.
...
* [func\_godot](https://github.com/func-godot/func_godot_plugin) ⭐ 851 | 🐛 12 | 🌐 GDScript | 📅 2026-09-08 - Import maps using the [Quake MAP file format](https://quakewiki.org/wiki/Quake_Map_Format), commonly made using an editor such as [TrenchBroom](https://trenchbroom.github.io/).
* [godot-ink](https://github.com/paulloz/godot-ink) ⭐ 785 | 🐛 12 | 🌐 C# | 📅 2026-07-04 - A C# (Mono) plugin to integrate stories writen in [ink](https://github.com/inkle/ink) ⭐ 4,945 | 🐛 371 | 🌐 C# | 📅 2026-05-05, a scripting language for writing interactive narrative.
...
* [YATI (Yet Another Tiled Importer](https://github.com/Kiamo2/YATI) ⭐ 295 | 🐛 9 | 🌐 GDScript | 📅 2026-03-19 - This is an addon for importing files (.tmx, .tmj) created by the [Tiled Map Editor](https://github.com/mapeditor/tiled) ⭐ 12,901 | 🐛 839 | 🌐 C++ | 📅 2026-09-17.
...
* [Sprouty Dialogs](https://github.com/SproutyLabs/SproutyDialogs) ⭐ 167 | 🐛 2 | 🌐 GDScript | 📅 2026-09-21 - A graph-based visual dialogue system, to create dialogues in your games incredibly easy! 🌱
...
* [Juicee](https://github.com/Kelpekk/Juicee) ⭐ 143 | 🐛 1 | 🌐 GDScript | 📅 2026-09-20 - game-feel effects (screen shake, hit stop, camera effects and more) with a visual graph editor, inspector UI, and one-liner API. Inspired by Unity's FEEL.
...
* [Goblend](https://github.com/Togira123/Goblend-Export-Addon) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Export Blender scenes to Godot with one click, including materials, collisions and nested scenes.
...
* [AgonesSDK](https://github.com/AndreMicheletti/godot-agones-sdk) ⭐ 88 | 🐛 0 | 🌐 GDScript | 📅 2026-06-09 - Plugin to add [Agones](https://github.com/googleforgames/agones) ⭐ 7,040 | 🐛 57 | 🌐 Go | 📅 2026-09-21 SDK functionality to Godot.
...
* [Godot Shaders](https://github.com/GDQuest/godot-shaders) ⭐ 4,128 | 🐛 6 | 🌐 GDShader | 📅 2026-05-16 - A large library of free and open-source shaders for 2D and 3D.
...
* [godot-voxel](https://github.com/Zylann/godot_voxel) ⭐ 3,904 | 🐛 247 | 🌐 C++ | 📅 2026-09-16 - Module for creating volumetric worlds.
...
* [godot-jolt](https://github.com/godot-jolt/godot-jolt) ⭐ 2,563 | 🐛 6 | 🌐 C++ | 📅 2026-03-16 - Allows you to use the [Jolt Physics Engine](https://github.com/jrouwe/JoltPhysics) ⭐ 11,569 | 🐛 13 | 🌐 C++ | 📅 2026-09-20.
* [Godex](https://github.com/GodotECS/godex) ⭐ 1,422 | 🐛 26 | 🌐 C++ | 📅 2023-09-18 - An entity component system library.
* [godot-rapier-2d](https://github.com/appsinacup/godot-rapier-2d) ⭐ 1,009 | 🐛 23 | 🌐 Rust | 📅 2026-09-20 - A 2D [Rapier](https://github.com/dimforge/rapier) ⭐ 5,756 | 🐛 54 | 🌐 Rust | 📅 2026-09-20 physics server for Godot.
...
* [JetBrains Rider (C#)](https://github.com/JetBrains/godot-support) ⭐ 506 | 🐛 37 | 🌐 Kotlin | 📅 2026-09-21 - Syntax highlighting, autocompletion and run configurations.
...
* [gdvm](https://gdvm.io) ([GitHub](https://github.com/adalinesimonian/gdvm) ⭐ 102 | 🐛 6 | 🌐 Rust | 📅 2026-09-21) - Command-line version manager for Godot Engine, allowing you to easily install and switch between different Godot versions on Windows, macOS, and Linux (x86, x86\_64, and ARM64).
