...
* [Worlds Upon The Wind](https://github.com/max99x/wutw-public) ⭐ 205 | 🐛 0 | 🌐 GDScript | 📅 2026-09-19 - A commercial roguelite deckbuilder released as public domain.
...
* [Starship Olympics](https://github.com/notapixelstudio/starship-olympics) ⭐ 525 | 🐛 130 | 🌐 GDScript | 📅 2026-09-19 - Fast-paced local party game with starships that battle in a top-down arena.
...
* [Thrive](https://github.com/Revolutionary-Games/Thrive/) ⭐ 3,711 | 🐛 525 | 🌐 C# | 📅 2026-09-18 - A free, open-source game about the evolution of life (Mono).
* [Reia](https://github.com/Quaint-Studios/Reia) ⭐ 948 | 🐛 16 | 🌐 GDScript | 📅 2026-09-11 - A free game that's an action adventure RPG for Desktop and Mobile with multiplayer, MMO, and offline support.
...
* [Pixelorama](https://github.com/Orama-Interactive/Pixelorama) ⭐ 10,336 | 🐛 86 | 🌐 GDScript | 📅 2026-09-15 - 2D pixel art editor.
* [Lorien](https://github.com/mbrlabs/Lorien) ⭐ 6,799 | 🐛 78 | 🌐 GDScript | 📅 2025-09-22 - Infinite-canvas drawing/whiteboarding app for Windows, Linux and macOS. Supports drawing tablets and pressure sensitivity.
* [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,926 | 🐛 321 | 🌐 GDScript | 📅 2026-09-14 - Create PBR materials procedurally (similar to Substance Designer).
* [GodSVG](https://github.com/MewPurPur/GodSVG) ⭐ 2,747 | 🐛 54 | 🌐 GDScript | 📅 2026-09-18 - Tool to create optimized Scalable Vector Graphics files.
...
* [Maaack's Game Template](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,654 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
...
* [First Person Starter](https://github.com/Whimfoome/godot-FirstPersonStarter) ⭐ 1,013 | 🐛 4 | 🌐 GDScript | 📅 2024-05-05 - Template with First Person Controller, easily adjustable from the Inspector.
...
* [Godot Demo Projects](https://github.com/godotengine/godot-demo-projects) ⭐ 9,541 | 🐛 86 | 🌐 GDScript | 📅 2026-09-08 - Official Godot demo projects (everything except the TPS demo).
* [OpenRPG](https://github.com/GDquest/godot-open-rpg) ⭐ 2,979 | 🐛 6 | 🌐 GDScript | 📅 2026-05-01 - JRPG-style game demo and template.
...
* [Realistic Water Shader](https://github.com/godot-extended-libraries/godot-realistic-water) ⭐ 963 | 🐛 8 | 🌐 GDShader | 📅 2026-04-15 - Realistic 3D water shader with foam and caustics.
...
* [Dialogic](https://github.com/dialogic-godot/dialogic) ⭐ 6,007 | 🐛 178 | 🌐 GDScript | 📅 2026-08-30 - Create dialogs, characters and scenes to display conversations.
* [Terrain3D](https://github.com/TokisanGames/Terrain3D) ⭐ 4,280 | 🐛 93 | 🌐 C++ | 📅 2026-09-15 - A high performance, editable 3D terrain system.
* [Dialogue Manager](https://github.com/nathanhoad/godot_dialogue_manager) ⭐ 3,863 | 🐛 2 | 🌐 GDScript | 📅 2026-09-09 - A simple but powerful text based branching dialogue editor and runtime. *(Godot 3 and 4)*
* [Phantom Camera](https://github.com/ramokz/phantom-camera) ⭐ 3,567 | 🐛 66 | 🌐 GDScript | 📅 2026-09-19 - Designed to provide and simplify common behaviors for the built-in Camera2D and Camera3D nodes.
* [Beehave](https://github.com/bitbrain/beehave) ⭐ 3,280 | 🐛 30 | 🌐 GDScript | 📅 2026-08-18 - Enables you to create robust NPC AI systems using behavior trees.
* [LimboAI](https://github.com/limbonaut/limboai) ⭐ 3,021 | 🐛 61 | 🌐 C++ | 📅 2026-09-04 - Behavior trees and state machines. Comes with editor, visual debugger, comprehensive demo and tutorial.
...
* [Maaack's Game Template Plugin](https://github.com/Maaack/Godot-Game-Template) ⭐ 1,654 | 🐛 13 | 🌐 GDScript | 📅 2026-09-10 - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
* [Orchestrator](https://github.com/Vahera/godot-orchestrator) ⭐ 1,628 | 🐛 123 | 🌐 C++ | 📅 2026-09-19 - Dialog and visual-scripting subsystem for 2D and 3D games.
* [Cyclops Level Builder](https://github.com/blackears/cyclopsLevelBuilder) ⭐ 1,615 | 🐛 88 | 🌐 GDScript | 📅 2026-09-17 - A level builder for quick prototypes and proof-of-concepts.
...
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,118 | 🐛 17 | 🌐 Rust | 📅 2026-09-19 - Local large language models (LLMs) for "AI-powered" NPC dialogue.
* [Input Helper](https://github.com/nathanhoad/godot_input_helper) ⭐ 1,101 | 🐛 11 | 🌐 GDScript | 📅 2025-06-08 - A helper for detecting input devices and remapping controls. *(Godot 3 and 4)*
* [Netfox](https://github.com/foxssake/netfox) ⭐ 1,096 | 🐛 49 | 🌐 GDScript | 📅 2026-09-18 - Multiplayer timing, rollback and other multiplayer features.
* [Script-IDE](https://github.com/Maran23/script-ide) ⭐ 1,049 | 🐛 9 | 🌐 GDScript | 📅 2026-09-02 - Transforms the script editor into an IDE-like UI. Multiline tabs, improved outline, quick open and override, enhanced keyboard navigation.
...
* [godot-ink](https://github.com/paulloz/godot-ink) ⭐ 784 | 🐛 12 | 🌐 C# | 📅 2026-07-04 - A C# (Mono) plugin to integrate stories writen in [ink](https://github.com/inkle/ink) ⭐ 4,941 | 🐛 371 | 🌐 C# | 📅 2026-05-05, a scripting language for writing interactive narrative.
...
* [Godot XR Tools](https://github.com/godotvr/godot-xr-tools) ⭐ 724 | 🐛 126 | 🌐 GDScript | 📅 2026-08-02 - Basic components for XR development.
...
* [Goblend](https://github.com/Togira123/Goblend-Export-Addon) ⭐ 104 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Export Blender scenes to Godot with one click, including materials, collisions and nested scenes.
...
* [AgonesSDK](https://github.com/AndreMicheletti/godot-agones-sdk) ⭐ 88 | 🐛 0 | 🌐 GDScript | 📅 2026-06-09 - Plugin to add [Agones](https://github.com/googleforgames/agones) ⭐ 7,028 | 🐛 62 | 🌐 Go | 📅 2026-09-18 SDK functionality to Godot.
...
* [Godot Shaders](https://github.com/GDQuest/godot-shaders) ⭐ 4,125 | 🐛 6 | 🌐 GDShader | 📅 2026-05-16 - A large library of free and open-source shaders for 2D and 3D.
...
* [godot-jolt](https://github.com/godot-jolt/godot-jolt) ⭐ 2,563 | 🐛 6 | 🌐 C++ | 📅 2026-03-16 - Allows you to use the [Jolt Physics Engine](https://github.com/jrouwe/JoltPhysics) ⭐ 11,563 | 🐛 12 | 🌐 C++ | 📅 2026-09-19.
* [Godex](https://github.com/GodotECS/godex) ⭐ 1,422 | 🐛 26 | 🌐 C++ | 📅 2023-09-18 - An entity component system library.
* [godot-rapier-2d](https://github.com/appsinacup/godot-rapier-2d) ⭐ 1,007 | 🐛 23 | 🌐 Rust | 📅 2026-09-15 - A 2D [Rapier](https://github.com/dimforge/rapier) ⭐ 5,747 | 🐛 53 | 🌐 Rust | 📅 2026-09-18 physics server for Godot.
...
* [JetBrains Rider (C#)](https://github.com/JetBrains/godot-support) ⭐ 506 | 🐛 35 | 🌐 Kotlin | 📅 2026-09-19 - Syntax highlighting, autocompletion and run configurations.
...
* [Zed](https://github.com/GDQuest/zed-gdscript) ⭐ 207 | 🐛 18 | 🌐 Tree-sitter Query | 📅 2026-09-10 - Syntax highlighting, autocompletion, LSP (jump-to-definition, hover, references, linting), code formatting, and debugging. Supports 3.x and 4.x.
...
* [ShipThis](https://github.com/shipth-is/cli) ⭐ 290 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - CLI to build and publish Godot mobile games to the App Store and Google Play.
