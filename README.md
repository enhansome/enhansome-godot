...
* [Worlds Upon The Wind](https://github.com/max99x/wutw-public) ⭐ 216 | 🐛 0 | 🌐 GDScript | 📅 2026-09-20 - A commercial roguelite deckbuilder released as public domain.
...
* [Starship Olympics](https://github.com/notapixelstudio/starship-olympics) ⭐ 525 | 🐛 131 | 🌐 GDScript | 📅 2026-09-22 - Fast-paced local party game with starships that battle in a top-down arena.
...
* [Thrive](https://github.com/Revolutionary-Games/Thrive/) ⭐ 3,714 | 🐛 528 | 🌐 C# | 📅 2026-09-22 - A free, open-source game about the evolution of life (Mono).
* [Reia](https://github.com/Quaint-Studios/Reia) ⭐ 953 | 🐛 16 | 🌐 GDScript | 📅 2026-09-11 - A free game that's an action adventure RPG for Desktop and Mobile with multiplayer, MMO, and offline support.
...
* [Pixelorama](https://github.com/Orama-Interactive/Pixelorama) ⭐ 10,350 | 🐛 86 | 🌐 GDScript | 📅 2026-09-20 - 2D pixel art editor.
* [Lorien](https://github.com/mbrlabs/Lorien) ⭐ 6,809 | 🐛 78 | 🌐 GDScript | 📅 2025-09-22 - Infinite-canvas drawing/whiteboarding app for Windows, Linux and macOS. Supports drawing tablets and pressure sensitivity.
* [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,937 | 🐛 325 | 🌐 GDScript | 📅 2026-09-20 - Create PBR materials procedurally (similar to Substance Designer).
* [GodSVG](https://github.com/MewPurPur/GodSVG) ⭐ 2,751 | 🐛 54 | 🌐 GDScript | 📅 2026-09-21 - Tool to create optimized Scalable Vector Graphics files.
...
* [Godot Demo Projects](https://github.com/godotengine/godot-demo-projects) ⭐ 9,555 | 🐛 86 | 🌐 GDScript | 📅 2026-09-08 - Official Godot demo projects (everything except the TPS demo).
...
* [Godot experiments](https://github.com/MrEliptik/godot_experiments) ⭐ 1,031 | 🐛 0 | 🌐 GDScript | 📅 2024-12-01 - Several 2D, 3D and VR experiments.
...
* [Open Source A-RPG Demo](https://github.com/GDQuest/godot-make-pro-2d-games) ⭐ 1,271 | 🐛 19 | 🌐 GDScript | 📅 2021-04-26 - RPG demo.
...
* [Dialogic](https://github.com/dialogic-godot/dialogic) ⭐ 6,015 | 🐛 178 | 🌐 GDScript | 📅 2026-08-30 - Create dialogs, characters and scenes to display conversations.
* [Terrain3D](https://github.com/TokisanGames/Terrain3D) ⭐ 4,284 | 🐛 90 | 🌐 C++ | 📅 2026-09-15 - A high performance, editable 3D terrain system.
* [Dialogue Manager](https://github.com/nathanhoad/godot_dialogue_manager) ⭐ 3,867 | 🐛 5 | 🌐 GDScript | 📅 2026-09-09 - A simple but powerful text based branching dialogue editor and runtime. *(Godot 3 and 4)*
...
* [Beehave](https://github.com/bitbrain/beehave) ⭐ 3,282 | 🐛 28 | 🌐 GDScript | 📅 2026-09-20 - Enables you to create robust NPC AI systems using behavior trees.
* [LimboAI](https://github.com/limbonaut/limboai) ⭐ 3,023 | 🐛 61 | 🌐 C++ | 📅 2026-09-04 - Behavior trees and state machines. Comes with editor, visual debugger, comprehensive demo and tutorial.
...
* [Cyclops Level Builder](https://github.com/blackears/cyclopsLevelBuilder) ⭐ 1,614 | 🐛 88 | 🌐 GDScript | 📅 2026-09-22 - A level builder for quick prototypes and proof-of-concepts.
...
* [TerraBrush](https://github.com/spimort/TerraBrush) ⭐ 1,285 | 🐛 28 | 🌐 C++ | 📅 2026-09-22 - Minimal Terrain heightmap editor that features sculpting, painting textures, LOD, and MultiZones.
* [GdUnit4](https://github.com/MikeSchulze/gdUnit4) ⭐ 1,239 | 🐛 13 | 🌐 GDScript | 📅 2026-08-30 - Godot Unit Testing Framework.
...
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,122 | 🐛 18 | 🌐 Rust | 📅 2026-09-22 - Local large language models (LLMs) for "AI-powered" NPC dialogue.
...
* [FMOD GDNative](https://github.com/utopia-rise/fmod-gdnative) ⭐ 936 | 🐛 73 | 🌐 C++ | 📅 2026-06-22 - Plugin to use the FMOD audio engine in GDScript.
...
* [Godot XR Tools](https://github.com/godotvr/godot-xr-tools) ⭐ 726 | 🐛 127 | 🌐 GDScript | 📅 2026-08-02 - Basic components for XR development.
...
* [YATI (Yet Another Tiled Importer](https://github.com/Kiamo2/YATI) ⭐ 295 | 🐛 9 | 🌐 GDScript | 📅 2026-03-19 - This is an addon for importing files (.tmx, .tmj) created by the [Tiled Map Editor](https://github.com/mapeditor/tiled) ⭐ 12,904 | 🐛 836 | 🌐 C++ | 📅 2026-09-21.
...
* [Juicee](https://github.com/Kelpekk/Juicee) ⭐ 144 | 🐛 1 | 🌐 GDScript | 📅 2026-09-20 - game-feel effects (screen shake, hit stop, camera effects and more) with a visual graph editor, inspector UI, and one-liner API. Inspired by Unity's FEEL.
...
* [AgonesSDK](https://github.com/AndreMicheletti/godot-agones-sdk) ⭐ 88 | 🐛 0 | 🌐 GDScript | 📅 2026-06-09 - Plugin to add [Agones](https://github.com/googleforgames/agones) ⭐ 7,041 | 🐛 55 | 🌐 Go | 📅 2026-09-21 SDK functionality to Godot.
...
* [Godot Shaders](https://github.com/GDQuest/godot-shaders) ⭐ 4,130 | 🐛 6 | 🌐 GDShader | 📅 2026-05-16 - A large library of free and open-source shaders for 2D and 3D.
...
* [godot-voxel](https://github.com/Zylann/godot_voxel) ⭐ 3,906 | 🐛 246 | 🌐 C++ | 📅 2026-09-16 - Module for creating volumetric worlds.
...
* [godot-jolt](https://github.com/godot-jolt/godot-jolt) ⭐ 2,564 | 🐛 6 | 🌐 C++ | 📅 2026-03-16 - Allows you to use the [Jolt Physics Engine](https://github.com/jrouwe/JoltPhysics) ⭐ 11,577 | 🐛 13 | 🌐 C++ | 📅 2026-09-20.
* [Godex](https://github.com/GodotECS/godex) ⭐ 1,422 | 🐛 26 | 🌐 C++ | 📅 2023-09-18 - An entity component system library.
* [godot-rapier-2d](https://github.com/appsinacup/godot-rapier-2d) ⭐ 1,010 | 🐛 23 | 🌐 Rust | 📅 2026-09-20 - A 2D [Rapier](https://github.com/dimforge/rapier) ⭐ 5,760 | 🐛 54 | 🌐 Rust | 📅 2026-09-20 physics server for Godot.
...
* [spout-gd](https://github.com/you-win/spout-gd) ⭐ 85 | 🐛 13 | 🌐 C++ | 📅 2025-12-24 - Share OpenGL textures across Windows applications through your GPU using [Spout](https://github.com/leadedge/Spout2) ⭐ 1,008 | 🐛 0 | 🌐 C++ | 📅 2026-09-22.
...
* [JetBrains Rider (C#)](https://github.com/JetBrains/godot-support) ⭐ 506 | 🐛 38 | 🌐 Kotlin | 📅 2026-09-22 - Syntax highlighting, autocompletion and run configurations.
